<header class="reserve_header">
    <div class="header_inner">
        ...
        <nav class="header_nav">
            ...
            <?php if ($is_logged_in): ?>
                <a href="mypage.php" class="header_user_info nav_link">
            ...
            <?php else: ?>
                <div class="header_user_info guest"> <svg class="user_icon" viewBox="0 0 24 24" width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="12" cy="7.5" r="4.0" stroke-linecap="round" />
                        <path d="M20 22C18.2 18.5 15 16.5 12 16.5C9 16.5 5.8 18.5 4 22" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <span class="user_name"><?= e($display_name) ?></span><span class="honorific">さん</span>
...
<!-- モバイルメニュー用オーバーレイ -->
<div class="mobile_menu_overlay" id="mobile_menu_overlay"></div>

<!-- モバイルメニュー -->
<div class="mobile_menu" id="mobileMenu">
    <div class="mobile_menu_inner">
        <?php if ($is_logged_in): ?>
            <a href="mypage.php" class="mobile_user_info nav_link">
                <svg class="user_icon" viewBox="0 0 24 24" width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="7.5" r="4.0" stroke-linecap="round" />
                    <path d="M20 22C18.2 18.5 15 16.5 12 16.5C9 16.5 5.8 18.5 4 22" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
        ...
        <?php else: ?>
            <div class="mobile_user_info guest">
                <svg class="user_icon" viewBox="0 0 24 24" width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="7.5" r="4.0" stroke-linecap="round" />
                    <path d="M20 22C18.2 18.5 15 16.5 12 16.5C9 16.5 5.8 18.5 4 22" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
