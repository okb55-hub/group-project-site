...
<body>
	...
	<main>
		...
		<div class="main_section">
			<div class="main_text">
				<p>当店では本格韓国料理のテイクアウトを<br class="sp_only">承っております。<br>サムギョプサルやビビンバ丼など人気メニューをご家庭やオフィスでもお楽しみいただけます。<br>ご予約はこちらのページからお願いします。
				</p>
			</div>
		...
		<div class="order_notice">
    		<h3>ご注文時の注意事項</h3>
    		<ul>
				<li>カートアイコンの数字は、選択した商品の種類数です。数量の変更はカート画面で行えます。</li>
