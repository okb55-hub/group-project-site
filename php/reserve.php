...
/*ヘッダーに名前を表示するための処理 */
$display_name = "ゲスト"; // 初期値
$is_logged_in = false; // ログイン状態を制御するフラグも用意しておくと便利
					...
					<form action="reserve.php" method="post">
						<div class="date_num_form">
							<div class="form_item">
								...
								<input type="date" name="reserve_date" id="reserve_date" min="<?= $tomorrow ?>" value="<?= htmlspecialchars($reserve_date) ?>">
